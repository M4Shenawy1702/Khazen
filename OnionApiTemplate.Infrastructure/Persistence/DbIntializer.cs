    ...
    : IDbInitializer
{
    ...
    private async Task SeedSafesAsync()
    {
        if (!await _context.Set<Safe>().AnyAsync())
        {
            ...
            Console.WriteLine("Seeded 3 Safe(s)");
        }
    }
    ...
    public async Task InitializeIdentityAsync()
    {
        ...
        if (!await _userManager.Users.AnyAsync() && !await _context.Set<Customer>().AnyAsync())
        {
            ...
            {
                (new ApplicationUser { Email = "SuperAdmin@gmail.com", UserName = "SuperAdmin", PhoneNumber = "1234567890", FullName = "Super Admin",  IsActive = true,EmailConfirmed = true, CreatedBy = "System" }, "SuperAdmin"),
                (new ApplicationUser { Email = "Admin@gmail.com",      UserName = "Admin",      PhoneNumber = "1234567890", FullName = "Admin User",   IsActive = true,EmailConfirmed = true, CreatedBy = "System" }, "Admin"),
                (new ApplicationUser { Email = "HR@gmail.com",         UserName = "HR",         PhoneNumber = "1234567890", FullName = "HR Manager",   IsActive = true,EmailConfirmed = true, CreatedBy = "System" }, "HRManager")
            };
        ...
        if (!await _context.Set<CompanySetting>().AnyAsync())
        {
            ...
            await _context.SaveChangesAsync();
            Console.WriteLine("Seeded CompanySetting");
        }
        ...
        if (!await _context.Set<SystemSetting>().AnyAsync())
        {
            ...
            {
                new SystemSetting { Key = "CashAccountId",              Value = "11111111-1111-1111-1111-111111111111", Description = "Default Cash Account",              Group = SystemSettingGroubType.Accounting, ValueType = SystemSettingValueType.Guid },
                new SystemSetting { Key = "BankAccountId",              Value = "11111111-1111-1111-1111-111111111112", Description = "Default Bank Account",              Group = SystemSettingGroubType.Accounting, ValueType = SystemSettingValueType.Guid },
                new SystemSetting { Key = "PurchasesAccountId",         Value = "66666666-6666-6666-6666-666666666666", Description = "Default Purchases Expense Account", Group = SystemSettingGroubType.Accounting, ValueType = SystemSettingValueType.Guid },
                new SystemSetting { Key = "AccountsReceivableAccountId",Value = "11111111-1111-1111-1111-111111111113", Description = "Default Accounts Receivable",       Group = SystemSettingGroubType.Accounting, ValueType = SystemSettingValueType.Guid },
                new SystemSetting { Key = "AccountsPayableAccountId",   Value = "22222222-2222-2222-2222-222222222221", Description = "Default Accounts Payable",          Group = SystemSettingGroubType.Accounting, ValueType = SystemSettingValueType.Guid },
                new SystemSetting { Key = "SalesRevenueAccountId",      Value = "44444444-4444-4444-4444-444444444441", Description = "Default Sales Revenue",             Group = SystemSettingGroubType.Accounting, ValueType = SystemSettingValueType.Guid },
                new SystemSetting { Key = "DiscountAllowedAccountId",   Value = "55555555-5555-5555-5555-555555555555", Description = "Default Discount Allowed Account",  Group = SystemSettingGroubType.Accounting, ValueType = SystemSettingValueType.Guid },
                new SystemSetting { Key = "CashSafeId",                 Value = "11111111-1111-1111-1111-111111111111", Description = "Main Cash Safe",                   Group = SystemSettingGroubType.Safe,       ValueType = SystemSettingValueType.Guid },
                new SystemSetting { Key = "BankSafeId",                 Value = "22222222-2222-2222-2222-222222222222", Description = "Main Bank Account",                Group = SystemSettingGroubType.Safe,       ValueType = SystemSettingValueType.Guid },
                new SystemSetting { Key = "DigitalWalletId",            Value = "33333333-3333-3333-3333-333333333333", Description = "Digital Wallet",                   Group = SystemSettingGroubType.Safe,       ValueType = SystemSettingValueType.Guid },
            };

            await _context.Set<SystemSetting>().AddRangeAsync(systemSettings);
            await _context.SaveChangesAsync();
            Console.WriteLine("Seeded SystemSettings");
        }
    }
