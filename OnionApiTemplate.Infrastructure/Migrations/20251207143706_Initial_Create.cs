        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false, comment: "The unique name of the brand."),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Code = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false, comment: "Unique account code (e.g., 1001 for Cash)"),
                    Name = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SafeTransactions_JournalEntries_JournalEntryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantityInStock = table.Column<int>(type: "int", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpectedUnitPrice = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseReceiptInvoices", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PurchaseReceiptInvoices_JournalEntries_JournalEntryId",
                        column: x => x.JournalEntryId,
                        principalTable: "JournalEntries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PurchaseReceiptInvoices_JournalEntries_ReversalJournalEntryId",
                        column: x => x.ReversalJournalEntryId,
                        principalTable: "JournalEntries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PurchaseReceiptInvoices_PurchaseOrders_PurchaseOrderId",
                        column: x => x.PurchaseOrderId,
                        principalTable: "PurchaseOrders",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PurchaseReceiptInvoices_Suppliers_SupplierId",
                        column: x => x.SupplierId,
                        principalTable: "Suppliers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SavedReports_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PurchaseInvoiceItem_PurchaseReceiptInvoices_PurchaseInvoiceId",
                        column: x => x.PurchaseInvoiceId,
                        principalTable: "PurchaseReceiptInvoices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PurchasePayments_JournalEntries_ReversalJournalEntryId",
                        column: x => x.ReversalJournalEntryId,
                        principalTable: "JournalEntries",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PurchasePayments_PurchaseReceiptInvoices_PurchaseInvoiceId",
                        column: x => x.PurchaseInvoiceId,
                        principalTable: "PurchaseReceiptInvoices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PurchasePayments_SafeTransactions_SafeTransactionId",
                        column: x => x.SafeTransactionId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PurchaseReceipts_PurchaseReceiptInvoices_InvoiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitPrice = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    DiscountType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, precision: 18, scale: 2, nullable: false),
                    DiscountValue = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    TaxRate = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalesInvoiceItem_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SalesInvoicePayment_JournalEntries_JournalEntryId",
                        column: x => x.JournalEntryId,
                        principalTable: "JournalEntries",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SalesInvoicePayment_JournalEntries_ReversalJournalEntryId",
                        column: x => x.ReversalJournalEntryId,
                        principalTable: "JournalEntries",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_SalesInvoicePayment_SalesInvoices_SalesInvoiceId",
                        column: x => x.SalesInvoiceId,
                        principalTable: "SalesInvoices",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Accounts_SafeId",
                table: "Accounts",
                column: "SafeId",
                unique: true,
                filter: "[SafeId] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchasePayments_ReversalJournalEntryId",
                table: "PurchasePayments",
                column: "ReversalJournalEntryId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchasePayments_SafeTransactionId",
                table: "PurchasePayments",
                column: "SafeTransactionId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseReceiptInvoices_InvoiceNumber",
                table: "PurchaseReceiptInvoices",
                column: "InvoiceNumber",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseReceiptInvoices_JournalEntryId",
                table: "PurchaseReceiptInvoices",
                column: "JournalEntryId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseReceiptInvoices_PurchaseOrderId",
                table: "PurchaseReceiptInvoices",
                column: "PurchaseOrderId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseReceiptInvoices_PurchaseReceiptId",
                table: "PurchaseReceiptInvoices",
                column: "PurchaseReceiptId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseReceiptInvoices_ReversalJournalEntryId",
                table: "PurchaseReceiptInvoices",
                column: "ReversalJournalEntryId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseReceiptInvoices_SupplierId",
                table: "PurchaseReceiptInvoices",
                column: "SupplierId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseReceiptInvoices_SupplierId_InvoiceNumber",
                table: "PurchaseReceiptInvoices",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseReceipts_InvoiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SafeTransactions_JournalEntryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Salaries_EmployeeId_SalaryDate",
                table: "Salaries",
                columns: new[] { "EmployeeId", "SalaryDate" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SalesInvoiceItem_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SalesInvoicePayment_JournalEntryId",
                table: "SalesInvoicePayment",
                column: "JournalEntryId");

            migrationBuilder.CreateIndex(
                name: "IX_SalesInvoicePayment_ReversalJournalEntryId",
                table: "SalesInvoicePayment",
                column: "ReversalJournalEntryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SavedReports_EmployeeId",
                table: "SavedReports",
                column: "EmployeeId");
            ...
            migrationBuilder.CreateIndex(
                ...
                column: "ProductId")
                .Annotation("SqlServer:Include", new[] { "PurchasePrice" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WarehouseProduct_Unique",
