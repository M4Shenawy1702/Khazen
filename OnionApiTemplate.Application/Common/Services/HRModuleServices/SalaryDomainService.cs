...
namespace Khazen.Application.Common.Services.HRModuleServices
{
    public class SalaryDomainService : ISalaryDomainService
    {
        private const decimal HalfDayFactor = 0.5m;

        public Salary CreateSalary(Employee employee, DateTime salaryDate, string createdBy, string? notes = null)
        {
            if (employee == null)
